...
$objFieldInfo->getList(" AND sub_cat_id='".SUB_DN_NDD_THONGTIN_KHAC."' AND isactive='1'", " ORDER BY sort asc");
$icon = "";
$i=0;
...
?>
	...
	<section class="col col-3">
		...
		<label class="textarea">
			...
			<textarea name="gr8_<?php echo SUB_DN_NDD_THONGTIN_KHAC;?>_<?php echo $rs['alias']?>[]" id="gr8_<?php echo SUB_DN_NDD_THONGTIN_KHAC;?>_<?php echo $rs['alias']?>"><?php echo $valueData;?></textarea>											
		</label>
	</section>
	<?php endif; ?>
	...
	<section class="col col-3">
		<label class="label"><?php echo $rs['name']?></label>
		<label class="select">
			<select name="gr8_<?php echo SUB_DN_NDD_THONGTIN_KHAC;?>_<?php echo $rs['alias']?>[]" id="gr8_<?php echo SUB_DN_NDD_THONGTIN_KHAC;?>_<?php echo $rs['alias']?>">
				<?php
					$fieldId = $rs['id'];
					$objOptionField->getList(" AND field_id=$fieldId", "");
					while ($r=$objOptionField->Fetch_Assoc()) { ?>
